...
public class JpaMain {
  public static void main(String[] args) {
    ...
    try {
      ...
      String sql = "SELECT MEMBER_ID, AGE, TEAM_ID, NAME FROM MEMBER WHERE NAME = 'kim'";
...
/*public class JpaMain {
  public static void main(String[] args) {
    ...
    try {
      ...
      member.getAddredssHistoyry().add(new AddressEntity("old1", "street", "10000"));
      member.getAddredssHistoyry().add(new AddressEntity("old2", "street", "10000"));
...
//      findMember.getAddredssHistoyry().remove(new Address("old1", "street", "10000"));
//      findMember.getAddredssHistoyry().add(new Address("newCity1", "street", "10000"));
